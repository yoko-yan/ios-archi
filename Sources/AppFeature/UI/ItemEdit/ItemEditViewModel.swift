...
//                    try await LocalImageRepository().save(spotImage, fileName: spotImageName)
...
//                    uiState.spotImage = await LocalImageRepository().load(fileName: uiState.input.spotImageName)
